...
urlpatterns = [
    ...
    # path('profile/',   TemplateView.as_view(template_name='panel-profile.html'),   name='profile-page'),
    ...
    path('admin_dashboard/', TemplateView.as_view(template_name='admin_dashboard.html'), name='admin-dashboard-page'),
